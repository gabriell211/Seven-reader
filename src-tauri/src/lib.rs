...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::start_batch_split_pdf,
            commands::start_batch_extract_pdf,
            commands::start_batch_rename_pdf,
            commands::start_batch_validate_pdfa,
            commands::start_batch_preflight_pdf,
