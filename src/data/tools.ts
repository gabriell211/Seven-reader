...
export const tools: ToolDefinition[] = [
  ...
  { id: "organize", label: "Organizar páginas", description: "Reordenar, extrair, dividir, girar e inserir.", icon: "pages", group: "Documento", capability: "pdf_engine", implemented: false },
