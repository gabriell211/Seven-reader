          ...
          {tab === "fill" ? (
            ...
            <>
              ...
              <section className="field-appearance-box">
                ...
                <div className="four-column-fields">
                  <label className="workflow-field"><span>Tamanho da fonte</span><input type="number" min={1} max={200} value={fieldFontSize} onChange={(event) => setFieldFontSize(Math.max(1, Math.min(200, Number(event.target.value) || 10)))} /></label>
